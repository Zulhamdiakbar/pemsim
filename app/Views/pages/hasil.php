        ...
        <div class="container custom__wrapper__pemsil">
            <div class="row">
                <div class="col">
                    <div class="d-flex flex-column custom__header">
                        <h1>Zulhamdi Akbar</h1>
                        <h1>152018128</h1>
                        <h4>ANALISIS PERAMALAN JUMLAH PENERIMAAN MAHASISWA BARU DENGAN MENGGUNAKAN METODE REGRESI LINEAR SEDERHANA</h4>
                    </div>
            ...
            <div class="custom__wrapper">
                ...
                <div class="custom__card__large">
                    <form enctype="multipart/form-data" role="form" action="<?= base_url('/Hasil/create'); ?>" method="post">
